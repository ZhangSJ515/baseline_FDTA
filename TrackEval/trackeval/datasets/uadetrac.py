...
class UADETRAC(_BaseDataset):
    ...
    layouts supported by ``data/uadetrac.py``. Tracker rows may use standard
    ...
    def get_default_dataset_config():
        ...
        return {
            ...
            "TRACKERS_FOLDER": os.path.join(
                code_path, "data/trackers/uadetrac"
            ),
            "OUTPUT_FOLDER": None,
                ...
                try:
                    if is_gt:
                        ...
                        (
                            ...
                            height,
                            score,
                        ) = self._parse_tracker(fields)
                except (TypeError, ValueError) as exc:
                    raise TrackEvalException(
                        f"Invalid UA-DETRAC row at {file_path}:"
    ...
    def get_preprocessed_seq_data(self, raw_data, cls):
        ...
        for timestep in range(raw_data["num_timesteps"]):
            ...
            data["tracker_ids"][timestep] = raw_data["tracker_ids"][timestep][
                tracker_mask
            ]
            data["tracker_dets"][timestep] = raw_data["tracker_dets"][timestep][
                tracker_mask
            ]
            data["tracker_confidences"][timestep] = raw_data[
                "tracker_confidences"
            ][timestep][tracker_mask]
